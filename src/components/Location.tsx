    ...
    <SectionWrapper id="location" className="bg-white">
      <div className="container mx-auto px-4 text-center">
        ...
        >
            ...
            <p className="text-stone-500">St. Mary's Cathedral, 123 Wedding Lane, Blue City</p>
        </motion.div>
        ...
        >
            <div className="rounded-2xl overflow-hidden h-64 md:h-96 w-full relative bg-gray-200">
                ...
                <iframe 
                    ...
                    loading="lazy" 
                    allowFullScreen 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14330.14371587328!2d17.587849187158223!3d59.85856385000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x465fcbfb85870d05%3A0xe542617f69826f03!2sUppsala%20Cathedral!5e0!3m2!1sen!2sse!4v1709214732296!5m2!1sen!2sse"
                />
            </div>
